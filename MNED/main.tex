...
% \textbf{Pares encajados}
% Tenemos dos métodos $ \{y_n\}\ O(h^4),\ \{z_n\} OH^{5} $.

% El análisis básico utiliza el método $ O(5) $ sólo para estimar el orden de truncatura. Esta la iea tomada en los métodos de Fehlberg.

% Se puede usar también el método de orden 5 para estimar el orden de truncatura y también para avanzar. Esta idea es la que se utiliza en el método de Dorman-Prince. 