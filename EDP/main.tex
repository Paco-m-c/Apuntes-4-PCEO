...
\begin{center}
  \begin{tikzpicture}
    ...
    \node[circle,inner sep=1pt,fill=red,label=left:{$0$}] at (0,0) {};
    % \filldraw [gray] (3,0) circle (2pt);
    \node[circle,inner sep=1pt,fill=red,label=right:{$a$}] at (3,0) {};
    % \filldraw [gray] (0,2) circle (2pt);
    \node[circle,inner sep=1pt,fill=red,label=left:{$b$}] at (0,2) {};
