...
\begin{demonstration}
  ...
  %$$ ||\alpha _2'(t)||^2=r'(t)^2 \cdot ||d(exp_{p_0})_{r(t) \cdot V(t)}(V(t))||^2 + 2\cdot r(t) \cdot r'(t)<d(exp_{p_0}_{r(t) \cdot V(t)})(V(t)), d(exp_{p_0}_{r(t) \cdot V(t)})(V'(t))>$$
%TODO DA ERROR
  %$$+ r(t)^2 ||d(exp_{p_0}_{r(t) \cdot V(t)})(V'(t))||^2$$
